...
import { SourceViewerProvider } from "~/features/chat/source-viewer";
          ...
          >
            <div className="flex items-end gap-3">
              <textarea
                ...
                className="max-h-40 flex-1 resize-none rounded-sm border border-input bg-card px-3 py-2.5 text-sm outline-none transition-colors focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/40"
              />
              {isStreaming ? (
                <button
                  type="button"
                  onClick={stop}
                  className="inline-flex shrink-0 cursor-pointer items-center gap-2 rounded-sm border border-border px-4 py-2.5 text-sm font-medium transition-colors hover:bg-accent"
                >
                ...
                <button
                  type="submit"
                  disabled={!draft.trim()}
                  className="inline-flex shrink-0 cursor-pointer items-center gap-2 rounded-sm bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-40"
                >
                  {t("chat.send")}
            ...
            <p className="mt-2 font-mono text-[0.65rem] tracking-wide text-muted-foreground">
              {t("chat.hint")}
            </p>
          </form>
        </div>
